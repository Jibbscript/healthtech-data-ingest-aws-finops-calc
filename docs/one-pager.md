...
**Cost posture:** the live Grafana cost dashboard converts real bytes/day and captures/day into current-burn $/user/month. Main levers are S3 lifecycle tiering, compression, Fargate right-sizing, and Spot processor workers.
